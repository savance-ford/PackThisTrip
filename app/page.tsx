...
const featuredPackingLists = [
  ...
  {
    title: "London in November",
    href: "/packing-list/london/november",
    description: "Late-autumn city packing with practical layers, rain protection, walking shoes, and UK travel essentials."
  },
  {
  ...
  {
    title: "New York in December",
    href: "/packing-list/new-york/december",
    description: "Cold-weather city checklist for walking, transit, rain or snow, and indoor plans."
  },
  {
